...
void cEnumStatesStorage::init()
{
	...
	addState(eKnowledges::Politics, "Politics");
	addState(eKnowledges::Fauna, "Fauna");
	addState(eKnowledges::History, "History");
	addState(eKnowledges::Architecture, "Architecture");
	addState(eKnowledges::Handicraft, "Handicraft");
	addState(eKnowledges::Medicine, "Medicine");
	addState(eKnowledges::Theology, "Theology");
	addState(eKnowledges::Weather, "Weather");
	addState(eKnowledges::Society, "Society");
	addState(eKnowledges::Warfare, "Warfare");
	addState(eKnowledges::Economy, "Economy");
	addState(eKnowledges::Flora, "Flora");
	addState(eKnowledges::Entertainment, "Entertainment");
	addState(eKnowledges::Culture, "Culture");
	addState(eKnowledges::Law, "Law");
	addState(eKnowledges::Family, "Family");
	addState(eKnowledges::Rumors, "Rumors");
	addState(eKnowledges::News, "News");
